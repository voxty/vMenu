        ...
        private void CreateMenu()
        {
            ...
            menu.OnItemSelect += (sender, item, index) =>
            {
                ...
                if (item == getAllWeapons)
                {
                    ...
                    var logString = $"All weapons given: All weapons given to player ${Game.Player.Name}.";
                    TriggerEvent("vMenu:discordLogs", "vMenu: Weapons", logString, 3113019);
                }
            ...
            menu.OnCheckboxChange += (sender, item, index, _checked) =>
            {
                if (item == noReload)
                {
                    ...
                    var logString = $"No reload {(_checked ? "enabled" : "disabled")} by " + Game.Player.Name;
                ...
                else if (item == unlimitedAmmo)
                {
                    ...
                    var logString = $"Unlimited ammo {(_checked ? "enabled" : "disabled")} by " + Game.Player.Name;
                    TriggerServerEvent("vMenu:discordLogs", "vMenu: Weapons", logString, 2045380);
                }
            };
            #endregion
