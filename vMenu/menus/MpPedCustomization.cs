...
namespace vMenuClient.menus
{
    public class MpPedCustomization
    {
        ...
        private void CreateSavedPedsMenu()
        {
            ...
            var saveCurrentPedAsCharacter = new MenuItem("Update Character Clothing", "This saves your current clothing options to this character. ~r~This will overwrite the save file entry for this character.~w~.")
